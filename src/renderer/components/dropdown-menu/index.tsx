...
const StyledMenuItem = styled(MantineMenu.Item)<MenuItemProps>`
    ...
    font-family: var(--global-content-font-family);
    font-size: var(--theme-dropdown-menu-item-font-size);
    ...
    &:hover {
        background-color: var(--theme-dropdown-menu-bg-hover);
    }
    ...
    & .mantine-Menu-itemLabel {
        ...
        margin-left: 1rem;
        color: ${(props) =>
            props.$danger ? 'var(--theme-danger-color)' : 'var(--theme-dropdown-menu-fg)'};
    }
...
const StyledMenuDropdown = styled(MantineMenu.Dropdown)`
    ...
    border: var(--theme-dropdown-menu-border);
