...
const StyledButton = styled(MantineButton)<StyledButtonProps>`
    color: ${(props) => `var(--theme-btn-${props.variant}-fg)`};
    background: ${(props) => `var(--theme-btn-${props.variant}-bg)`};
    border: ${(props) => `var(--theme-btn-${props.variant}-border)`};
    border-radius: ${(props) => `var(--theme-btn-${props.variant}-radius)`};
    transition:
    ...
    svg {
        fill: ${(props) => `var(--theme-btn-${props.variant}-fg)`};
    ...
    &:not([data-disabled])&:hover {
        color: ${(props) => `var(--theme-btn-${props.variant}-fg) !important`};
        background: ${(props) => `var(--theme-btn-${props.variant}-bg)`};
        filter: brightness(85%);
        border: ${(props) => `var(--theme-btn-${props.variant}-border-hover)`};

        svg {
            fill: ${(props) => `var(--theme-btn-${props.variant}-fg-hover)`};
        }
    }

    &:not([data-disabled])&:focus-visible {
        color: ${(props) => `var(--theme-btn-${props.variant}-fg-hover)`};
        background: ${(props) => `var(--theme-btn-${props.variant}-bg)`};
        filter: brightness(85%);
    }
