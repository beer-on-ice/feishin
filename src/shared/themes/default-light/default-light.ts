...
export const defaultLight: AppThemeConfiguration = {
    app: {
        ...
        'btn-filled-bg': 'var(--ui-primary-color)',
        'btn-filled-fg': '#fff',
        ...
        'modal-header-bg': 'var(--ui-paper-bg)',
        ...
        'switch-track-enabled-bg': 'var(--ui-primary-color)',
        'table-alt-bg': 'var(--ui-main-bg)',
        'table-bg': 'var(--ui-main-bg)',
        'table-border': 'none',
